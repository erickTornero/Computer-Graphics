...
public:
    ...
    GLfloat xDir = 0.0f, GLfloat yDir = -1.0f, GLfloat zDir = 0.0f, GLfloat dIntensity = 0.0f):colour(glm::vec3(red, green, blue)), ambientIntensity(aIntensity), direction(glm::vec3(xDir, yDir, zDir)), diffuseIntensity(dIntensity){}
