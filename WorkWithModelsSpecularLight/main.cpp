...
int main(){
    ...
    mainLight = Light(0.4f, 0.4f, 0.4f, 0.1f, 
                        2.0f, -1.0f, -2.0f, 0.1f);
    GLuint uniformSpecularIntensity = 0, uniformShininess = 0, uniformEyePosition;
    ...
    while(!window->getShouldClose()){
        ...
        model = glm::translate(model, glm::vec3(-1.2f, 2.0f, -2.5f));
