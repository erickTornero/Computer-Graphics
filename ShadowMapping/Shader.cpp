...
void Shader::CompileShader(const char * vertexCode, const char * fragmentCode){
    ...
    this->uniformSpecularIntensity = glGetUniformLocation(shaderID, "material.specularIntensity");
    this->uniformShininess = glGetUniformLocation(shaderID, "material.shininess");
    this->uniformEyePosition = glGetUniformLocation(shaderID, "eyePosition");
}
